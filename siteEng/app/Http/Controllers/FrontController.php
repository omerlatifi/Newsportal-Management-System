...
class FrontController extends Controller
{
    public function index(){
        ...
        $firstSectionNews  = News::where('publish_site',0)->where('status',1)
        ->where('trash_status',0)->where('approve_status',1)
        ->where('home_page_position','first')->orderBy('id','desc')->first();



        $firstSectionNewsEnglish  = News::where('publish_site',1)->where('status',1)
        ->where('trash_status',0)->where('approve_status',1)
        ->where('home_page_position','first')->orderBy('id','desc')->first();


        $secondSectionNews  = News::where('publish_site',0)->where('status',1)
        ->where('trash_status',0)->where('approve_status',1)
        ->where('home_page_position','second')->orderBy('id','desc')->limit(2)->get();


        $thirdSectionNewsTwo  = News::where('publish_site',0)->where('status',1)
        ->where('trash_status',0)->where('approve_status',1)
        ->where('home_page_position','third')->orderBy('id','desc')->limit(3)->get();


        $thirdSectionNewsTwoEnglish  = News::where('publish_site',1)->where('status',1)
        ->where('trash_status',0)->where('approve_status',1)
        ->where('home_page_position','third')->orderBy('id','desc')->limit(3)->get();


        $fourthSectionNewsTwo  = News::where('publish_site',0)->where('status',1)
        ->where('trash_status',0)->where('approve_status',1)
        ->where('home_page_position','fourth')->orderBy('id','desc')->limit(1)->get();


        $fourthSectionNewsTwoEnglish  = News::where('publish_site',1)->where('status',1)
        ->where('trash_status',0)->where('approve_status',1)
        ->where('home_page_position','fourth')->orderBy('id','desc')->limit(1)->get();


        $latestBanglaNews  = News::where('publish_site',0)->where('status',1)
    ...
    public function news($id){
        ...
        $newsListOne = News::where('publish_site',0)->where('status',1)
                            ->where('trash_status',0)->where('approve_status',1)
                            ->where('category',$id)->orderBy('id','desc')->limit(1)->get();
        
                            $newsListTwo = News::where('publish_site',0)->where('status',1)
                            ->where('trash_status',0)->where('approve_status',1)
                            ->where('category',$id)->orderBy('id','desc')->skip(1)->take(4)->get();


                            $newsListThree = News::where('publish_site',0)->where('status',1)
                            ->where('trash_status',0)->where('approve_status',1)
                            ...
                            $latestBanglaNewsPopular  = News::where('publish_site',0)->where('status',1)
