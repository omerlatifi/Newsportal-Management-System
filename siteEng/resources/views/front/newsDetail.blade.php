        ...
        <section>
            <div class="single-cat-info">
                ...
                <div class="single-cat-cate"><a href="{{ route('news',base64_encode($latestNewsDetail->category)) }}" rel="category tag"><i class="fa fa-bars"
                                                                                        aria-hidden="true"></i>
                                                                                        {{ \App\Models\Category::where('id',$latestNewsDetail->category)->value('eng_name') }}</a></div>
            </div>
            <div class="row">
    ...
    বুধবার', 'বৃহস্পতিবার', 'শুক্রবার','পূর্বাহ্ন','অপরাহ্ন '
                        ...
                        <div class="row">
                            <div class="col-sm-12 text-left pDate">
                                <p>Published At: {{$latestNewsDetail->create_time}}, {{ date("d F Y", strtotime($latestNewsDetail->create_date)) }}</p>
                                <p>Updated At : {{$latestNewsDetail->create_time}}, {{date("d F Y", strtotime($latestNewsDetail->create_date))}}</p>
                            </div>
                        </div>
                    </div>
                </div>
