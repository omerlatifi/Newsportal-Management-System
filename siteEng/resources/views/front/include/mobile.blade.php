                    ...
                    <div class="row pb-4">
                        <div class="col-xl p-0">
                            <div class="MobileDateArea">
                                <p class="date">
                                    <i class="fa fa-map-marker" aria-hidden="true"></i> Dhaka, &nbsp;{{ $convertedday }}&nbsp;
                        ...
                        <div class="col-6">
                            <ul>
                                ...
                                <li class="nav-item"><a class="nav-link" href="{{ route('news',base64_encode($headerCats->id)) }}">{{ $headerCats->eng_name }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                        <div class="col-6">
                            <ul>
                                ...
                                <li class="nav-item"><a class="nav-link" href="{{ route('subCategoryNews',base64_encode($headerCats->id)) }}">{{ $headerCats->eng_name }}</a>
                                </li>
                                @endforeach
