...
@section('title')
{{ \App\Models\Category::where('id',$id)->value('eng_name') }}
@endsection
    ...
    <div class="container">
        <div class="single-cat-info">
            <div class="single-cat-home">
                <a href="{{ route('index') }}"><i class="fa fa-home" aria-hidden="true"></i> Cover</a>
            </div>
            <div class="single-cat-cate">
                <a href="{{ route('news',base64_encode($id)) }}" rel="category tag"><i class="fa fa-bars" aria-hidden="true"></i>
                    {{ \App\Models\Category::where('id',$id)->value('eng_name') }}</a>
            </div>
        </div>
        ...
        <div class="DCatNewsList3Area">
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    <section>
                        <p class="catTitle">All News Of {{ \App\Models\Category::where('id',$id)->value('eng_name') }}</p>
                        <div class="row">
                            <div class="col-12">
