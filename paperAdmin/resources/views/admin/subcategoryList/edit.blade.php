                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="eng_name" value="{{ $subcategoryListEdit->eng_name }}" class="form-control" placeholder="English Name">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example3" class="table table-hover no-wrap product-order" data-page-size="10">
                            <tr>
                                <th>SL</th>
