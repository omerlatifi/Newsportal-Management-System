...
@section('css')
<link href="{{ asset('/') }}public/adminold/assets/jquery-editable-select.min.css" rel="stylesheet" />
...
@endsection
@section('script')
 <script src="{{ asset('/') }}public/adminold/assets/jquery-editable-select.js"></script>
