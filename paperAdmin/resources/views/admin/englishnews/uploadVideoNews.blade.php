...
<section class="content">
    <form class="custom-validation" action="{{ route('englishNews.store') }}" method="post" enctype="multipart/form-data" id="form" data-parsley-validate="">
        @csrf
    <div class="row">
...
?>
                            ...
                            <div class="col-lg-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" required class="form-control" name="video_news" value="1" placeholder="Sub-Title">
                ...
                <div class="card-body">
                    <div class="col-lg-12 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" required class="form-control" name="image_caption" placeholder="Youtube Video Link">
                        </div>
                    </div>
                </div>
            </div>
