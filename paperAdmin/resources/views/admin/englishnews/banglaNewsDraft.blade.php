...
<div class="content-body">
    ...
    <div class="d-flex align-items-center">
        <div class="me-auto">
            <h4 class="page-title">English News Draft List</h4>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header with-border">
                    <h3 class="card-title">All English News Draft List</h3>
                ...
                <div class="card-body" id="main_content_table">
                    ...
                    {{ $productLists->title }}
                                ...
                                <td style="width: 15%">
                                    ...
                                    <form id="delete-form-{{ $productLists->id }}" action="{{ route('englishBanglaNewsDraftPublish',$productLists->id) }}" method="POST" style="display: none;">
                                        @method('get')
                                                                                          @csrf
