<ul class="pagination pagination-rounded justify-content-end mb-2">
    ...
    <li class="page-item disabled">
      <button  class="page-link" id="papage_link"> <i class="fa fa-angle-double-left"></i></button>
  </li>

    @else
    <li class="page-item ">
      <button  class="page-link" id="papage_link{{ $id_for_pass }}"> <i class="fa fa-angle-double-left"></i></button>
  </li>
  @endif
...
<li class="page-item disabled">
<button  class="page-link disabled" id="napage_link"> <i class="fa fa-angle-double-right"></i></button>
</li>
@else
<li class="page-item ">
<button  class="page-link" id="napage_link{{ $id_for_pass }}"> <i class="fa fa-angle-double-right"></i></button>
</li>
@endif
