 ...
 <ul class="pagination pagination-rounded justify-content-end mb-2">
    ...
    <li class="page-item disabled">
      <button  class="page-link" id="ppage_link"><i class="fa fa-angle-double-left"></i></button>
  </li>
...
<!--next button work -->
<li class="page-item ">
<button  class="page-link" id="npage_link"><i class="fa fa-angle-double-right"></i></button>
</li>
