...
@section('title')
Bangla News Approval Pending List
@endsection
...
<div class="content-body">
    ...
    <div class="d-flex align-items-center">
        <div class="me-auto">
            <h4 class="page-title">Bangla News Approval Pending List</h4>
        </div>
...
<div class="row">
    ...
    @if (Auth::guard('admin')->user()->can('approvenews'))
    <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <form id="delete-form-0" action="{{ route('approveAll',0) }}" method="POST" style="display: none;">
            @method('get')
                                                              @csrf
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header with-border">
                    <h3 class="card-title">Bangla News Approval Pending List</h3>
                ...
                <div class="card-body" id="main_content_table">
                    ...
                    {{ $productLists->title }}
                                ...
                                <td style="width: 15%">
                                    ...
                                    <form id="delete-form-{{ $productLists->id }}" action="{{ route('approveNewsFromMain',$productLists->id) }}" method="POST" style="display: none;">
                                        @method('get')
                                                                                          @csrf
