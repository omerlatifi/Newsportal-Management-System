...
<div class="content-body">
    ...
    <div class="d-flex align-items-center">
        <div class="me-auto">
            <h4 class="page-title">Bangla News List</h4>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header with-border">
                    <h3 class="card-title">All Bangla News List</h3>
                ...
                <div class="card-body" id="main_content_table">
                    ...
                    {{ $productLists->title }}
                                ...
                                <td style="width: 15%">
                                    ...
                                    <form id="delete-form-{{ $productLists->id }}" action="{{ route('news.destroy',$productLists->id) }}" method="POST" style="display: none;">
                                        @method('DELETE')
                                                                                          @csrf
                    ...
                    @include('admin.banglanews.normal_pagination')
...
success: function(data) {
  ...
  $("#main_content_table").html(data.options);
    ...
    $.ajax({
url: "{{ route('paginationStartSearchAjax') }}",
method: 'GET',
...
$.ajax({
url: "{{ route('paginationStartSearch') }}",
type: "GET",
