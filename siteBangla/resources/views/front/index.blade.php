...
<main>
        ...
        <div class="DTopSection">
            <div class="row">
                ...
                <div class="col-lg-4 col-12 colresize" style="width: 27.5%;">
                    ...
                    <div class="SectionTitle MT30"><h3><a href="{{ route('subCategoryNews',base64_encode(13)) }}">মতামত<i class="ti-infinite"></i></a>
                        </h3></div>

                        <?php    
                        
                        $oponionOne = \App\Models\News::where('publish_site',1)->where('status',1)
        ->where('trash_status',0)->where('approve_status',1)
        ->where('sub_category',13)->orderBy('id','desc')->limit(1)->get();


        $oponionTwo = \App\Models\News::where('publish_site',1)->where('status',1)
        ->where('trash_status',0)->where('approve_status',1)
        ...
        <div class="DBangla">
            <div class="row">
                <div class="col-sm-9 border-right-inner">
                    <div class="DBanglaTitle"><a href="{{ $eng_ins_url }}">
                            <h2 class="Title">English Highlights</h2></a></div>
                    <div class="DBanglaNews">
                        ...
                        @else
                                            <a href="{{ url($eng_ins_url) }}{{ 'newsDetail/'.$firstSectionNewsEnglish->title_slug }}">
                                                <div class="Imgresize">
                                                    <figure class="ImgViewer">
                                                        <picture class="FixingRatio">
                                                            <img
                                    ...
                                    <div class="col-lg-5 col-12">
                                        <div class="DCommonCatS1List">
                                            ...
                                            <div class="DBanglaListItem">
                                                <a href="{{ url($eng_ins_url) }}{{ 'newsDetail/'.$secondSectionNewss->title_slug }}">
                                                    <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="DEnLatestTitle"><p>সর্বশেষ</p></div>
    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-lg-9 border-right-inner">
                    <div class="SectionTitle"><h3>
                            <a href="{{ route('news',base64_encode(4)) }}">বাংলাদেশ<i
        ...
        $bdTwo = \App\Models\News::where('publish_site',1)->where('status',1)
        ->where('trash_status',0)->where('approve_status',1)
            ...
            <div class="row">
                <div class="col-lg-12 border-right-inner">
                    <div class="SectionTitle MT30"><h3>
                            <a href="{{ route('news',base64_encode(6)) }}">আন্তর্জাতিক<i
                                        class="ti-infinite"></i></a></h3></div>


                                        <?php    
                        
                                        $intOne = \App\Models\News::where('publish_site',1)->where('status',1)
                        ->where('trash_status',0)->where('approve_status',1)
                        ->where('category',6)->orderBy('id','desc')->limit(1)->get();
                
                
                        $intTwo = \App\Models\News::where('publish_site',1)->where('status',1)
                        ->where('trash_status',0)->where('approve_status',1)
                        ->where('category',6)->orderBy('id','desc')->skip(1)->take(3)->get();


                        $intThree = \App\Models\News::where('publish_site',1)->where('status',1)
                        ->where('trash_status',0)->where('approve_status',1)
        ...
        <section class="National + Politics mt-5">
            <div class="row">
                <div class="col-lg-9 border-right-inner">
                    <div class="SectionTitle"><h3>
                            <a href="{{ route('news',base64_encode(7)) }}">রাজনীতি<i class="ti-infinite"></i></a>
                        </h3></div>

                        <?php    
                        
                        $polOne = \App\Models\News::where('publish_site',1)->where('status',1)
        ->where('trash_status',0)->where('approve_status',1)
        ->where('category',7)->orderBy('id','desc')->limit(1)->get();


        $polTwo = \App\Models\News::where('publish_site',1)->where('status',1)
        ->where('trash_status',0)->where('approve_status',1)
        ...
        <section class="Sports">
            <div class="row">
                <div class="col-lg-12">
                    <div class="SectionTitle MT30"><h3><a href="{{ route('news',base64_encode(8)) }}">খেলাধুলা<i
                                        class="ti-infinite"></i></a></h3></div>

                                        <?php    
                        
                                        $spOne = \App\Models\News::where('publish_site',1)->where('status',1)
                        ->where('trash_status',0)->where('approve_status',1)
                        ->where('category',8)->orderBy('id','desc')->limit(1)->get();
                
                
                        $spTwo = \App\Models\News::where('publish_site',1)->where('status',1)
                        ->where('trash_status',0)->where('approve_status',1)
                        ->where('category',8)->orderBy('id','desc')->skip(1)->take(1)->get();


                        $spThree = \App\Models\News::where('publish_site',1)->where('status',1)
                        ->where('trash_status',0)->where('approve_status',1)
        ...
        <section class="Countrywide">
            <div class="row">
                <div class="col-lg-12">
                    <div class="SectionTitle MT30"><h3>
                            <a href="{{ route('news',base64_encode(9)) }}">সারাদেশ<i
                                        class="ti-infinite"></i></a></h3></div>


                                        <?php    
                        
                                        $conOne = \App\Models\News::where('publish_site',1)->where('status',1)
                        ->where('trash_status',0)->where('approve_status',1)
                        ->where('category',9)->orderBy('id','desc')->limit(1)->get();
                
                
                        $conTwo = \App\Models\News::where('publish_site',1)->where('status',1)
                        ->where('trash_status',0)->where('approve_status',1)
                        ->where('category',9)->orderBy('id','desc')->skip(1)->take(3)->get();


                        $conThree = \App\Models\News::where('publish_site',1)->where('status',1)
                        ->where('trash_status',0)->where('approve_status',1)
        ...
        <section class="Business">
            <div class="row">
                <div class="col-lg-12">
                    <div class="SectionTitle MT30"><h3><a href="{{ route('news',base64_encode(10)) }}">অর্থনীতি<i class="ti-infinite"></i></a>
                        </h3></div>

                        <?php    
                        
                        $ecoOne = \App\Models\News::where('publish_site',1)->where('status',1)
        ->where('trash_status',0)->where('approve_status',1)
        ->where('category',10)->orderBy('id','desc')->limit(1)->get();


        $ecoTwo = \App\Models\News::where('publish_site',1)->where('status',1)
        ->where('trash_status',0)->where('approve_status',1)
        ->where('category',10)->orderBy('id','desc')->skip(1)->take(1)->get();


        $ecoThree = \App\Models\News::where('publish_site',1)->where('status',1)
        ->where('trash_status',0)->where('approve_status',1)
        ...
        <section class="Entertainment">
            <div class="row">
                <div class="col-lg-12">
                    <div class="SectionTitle MT30"><h3><a href="{{ route('news',base64_encode(11)) }}">বিনোদন<i
                                        class="ti-infinite"></i></a></h3></div>

                                        <?php    
                        
                                        $eOne = \App\Models\News::where('publish_site',1)->where('status',1)
                        ->where('trash_status',0)->where('approve_status',1)
                        ->where('category',11)->orderBy('id','desc')->limit(5)->get();
                
                
                        $eTwo = \App\Models\News::where('publish_site',1)->where('status',1)
                        ->where('trash_status',0)->where('approve_status',1)
                        ->where('category',11)->orderBy('id','desc')->skip(5)->take(1)->get();
                
                
                        $eThree = \App\Models\News::where('publish_site',1)->where('status',1)
                        ->where('trash_status',0)->where('approve_status',1)
            ...
            <section class="Science & IT + Education + Law & Court">
                <div class="row">
                    <div class="col-lg-4 col-12 border-right-inner">
                        <div class="SectionTitle"><h3><a href="{{ route('news',base64_encode(12)) }}">বিজ্ঞান ও প্রযুক্তি<i
                                            class="ti-infinite"></i></a></h3></div>


                                            <?php    
                        
                                        $bOne = \App\Models\News::where('publish_site',1)->where('status',1)
                        ->where('trash_status',0)->where('approve_status',1)
                        ->where('category',12)->orderBy('id','desc')->limit(1)->get();
                
                
                        $bTwo = \App\Models\News::where('publish_site',1)->where('status',1)
                        ->where('trash_status',0)->where('approve_status',1)
                    ...
                    <div class="col-lg-4 col-12 border-right-inner">
                        <div class="SectionTitle"><h3><a href="{{ route('news',base64_encode(13)) }}">শিক্ষাঙ্গন<i
                                            class="ti-infinite"></i></a></h3></div>

                                            <?php    
                        
                                        $edOne = \App\Models\News::where('publish_site',1)->where('status',1)
                        ->where('trash_status',0)->where('approve_status',1)
                        ->where('category',13)->orderBy('id','desc')->limit(1)->get();
                
                
                        $edTwo = \App\Models\News::where('publish_site',1)->where('status',1)
                        ->where('trash_status',0)->where('approve_status',1)
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="SectionTitle"><h3><a href="{{ route('news',base64_encode(14)) }}">আপরাধ ও বিচার<i
                                            class="ti-infinite"></i></a></h3></div>

                                            <?php    
                        
                                            $opOne = \App\Models\News::where('publish_site',1)->where('status',1)
                            ->where('trash_status',0)->where('approve_status',1)
                            ->where('category',14)->orderBy('id','desc')->limit(1)->get();
                    
                    
                            $opTwo = \App\Models\News::where('publish_site',1)->where('status',1)
                            ->where('trash_status',0)->where('approve_status',1)
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="CommonCatArea">
                        <div class="SectionTitle"><h3><a href="{{ route('news',base64_encode(16)) }}">ফিচার<i class="ti-infinite"></i></a>
                            </h3></div>

                            <?php    
                        
                                            $ffOne = \App\Models\News::where('publish_site',1)->where('status',1)
                            ->where('trash_status',0)->where('approve_status',1)
        ...
        <section class="PhotoStory + Videogallery">
            <div class="CommonCatArea2">
                <div class="row">
                    <div class="col-lg-8 col-12 border-right-inner">
                        <div class="SectionTitle"><h3><a href="{{ route('subCategoryNews',base64_encode(15)) }}">ছবি<i
                                            class="ti-infinite"></i></a></h3></div>

                                            <?php    
                        
                                            $imageOne = \App\Models\News::where('publish_site',1)->where('status',1)
                            ->where('trash_status',0)->where('approve_status',1)
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="SectionTitle"><h3><a href="{{ route('subCategoryNews',base64_encode(16)) }}">ভিডিও<i
                                            class="ti-infinite"></i></a></h3></div>

                                            <?php    
                        
                                            $videoOne = \App\Models\News::where('publish_site',1)->where('status',1)
                            ->where('trash_status',0)->where('approve_status',1)
                            ->where('sub_category',16)->orderBy('id','desc')->limit(1)->get();


                            $videoTwo = \App\Models\News::where('publish_site',1)->where('status',1)
                            ->where('trash_status',0)->where('approve_status',1)
