...
@section('title')
{{ \App\Models\Category::where('id',$id)->value('category_name') }}
@endsection
        ...
        <div class="single-cat-info">
            ...
            <div class="single-cat-cate">
                <a href="{{ route('news',base64_encode($id)) }}" rel="category tag"><i class="fa fa-bars" aria-hidden="true"></i>
                    {{ \App\Models\Category::where('id',$id)->value('category_name') }}</a>
            </div>
        </div>
        ...
        <div class="DCatNewsList3Area">
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    <section>
                        <p class="catTitle">{{ \App\Models\Category::where('id',$id)->value('category_name') }} বিভাগের সব খবর</p>
                        <div class="row">
                            <div class="col-12">
